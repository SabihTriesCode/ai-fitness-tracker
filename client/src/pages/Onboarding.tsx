              ...
              <div className="space-y-8 max-w-lg">
                ...
                <div className="space-y-6">
                  <Slider
                    ...
                    unit="kcal"
                    infoText="The total calorie you plan to consume each day."
                  />
                  <Slider
                    ...
                    unit="kcal"
                    infoText="The total calorie you plan to burn through exercises and activities each day."
                  />
                </div>
              </div>
            </div>
          ...
          <div className="flex gap-3 lg:justify-end">
            {step > 1 && (
              <Button
                ...
                className="max-lg:flex-1 lg:px-7 py-2 rounded-lg text-sm font-medium"
              >
